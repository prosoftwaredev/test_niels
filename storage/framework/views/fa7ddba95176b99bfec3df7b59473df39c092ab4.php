...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header'); ?> 
        <div class="flex justify-center items-center">
            ...
            <a href="<?php echo e(route('countries.create')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
...
<?php endif; ?>
                    ...
                    <form action="<?php echo e(route('countries.index')); ?>" method="GET" role="search">
                            ...
                            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="px-3 py-2 whitespace-no-wrap">
                                        <a href="<?php echo e(route('countries.edit', ['country' => $country->id])); ?>" class="underline text-gray-600 hover:text-gray-900">
                                        <?php echo e($country->name); ?>

                                    </td>
                                    <td class="px-3 py-2 whitespace-no-wrap"><?php echo e($country->country_code); ?></td>
                                    <td class="px-3 py-2 whitespace-no-wrap flex flex-row">
                                        <form method="POST" action="<?php echo e(route('countries.destroy', ['country' => $country->id])); ?>">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH /home/error404/WorkSpace/laravue3/resources/views/countries/index.blade.php ENDPATH**/ ?>