...
<?php endif; ?>
                    ...
                    <form method="POST" action="<?php echo e(route('states.store')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
                        ...
                        <div class="mt-4">
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.label','data' => ['for' => 'country','value' => __('Country')]]); ?>
<?php $component->withName('label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
                            ...
                            <select id="country" class="block w-full mt-1 pl-3 pr-10 py-2 transition duration-100 ease-in-out border rounded shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed" name="country_id" :value="old('country_id')" required autofocus>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH /home/error404/WorkSpace/laravue3/resources/views/states/create.blade.php ENDPATH**/ ?>