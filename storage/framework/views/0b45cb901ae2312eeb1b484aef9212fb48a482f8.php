...
<?php endif; ?>
                    ...
                    <form action="<?php echo e(route('departments.index')); ?>" method="GET" role="search">
                            ...
                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="px-3 py-2 whitespace-no-wrap">
                                        <a href="<?php echo e(route('departments.edit', ['department' => $department->id])); ?>" class="underline text-gray-600 hover:text-gray-900">
                                        <?php echo e($department->name); ?>

                                    </td>
                                    <td class="px-3 py-2 whitespace-no-wrap flex flex-row">
                                        <form method="POST" action="<?php echo e(route('departments.destroy', ['department' => $department->id])); ?>">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH /home/error404/WorkSpace/laravue3/resources/views/departments/index.blade.php ENDPATH**/ ?>