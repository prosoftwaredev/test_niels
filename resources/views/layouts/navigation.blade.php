    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('employments')" :active="request()->routeIs('employments')">
                        {{ __('Employments') }}
                    </x-nav-link>
                </div>
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link-parent :href="'#'" :active="request()->routeIs('countries.*')">
                        <x-slot name="name">{{ __('System') }}</x-slot>
